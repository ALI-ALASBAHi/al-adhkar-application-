            ...
            child: ListView(
              ...
              children: [
                ...
                _tile(
                  ...
                  trailing: Text(languageService.isArabic ? 'عربي' : 'English'),
                ),
                _tile(
                  context,
                  Icons.text_fields,
                  languageService.t('arabic_font_size'),
                ),
                _tile(
                  context,
                  Icons.alarm,
                  languageService.t('prayer_reminders'),
                  trailing: Switch(value: true, onChanged: (_) {}),
                ),
                _tile(
                  context,
                  Icons.volume_up,
                  languageService.t('audio_pronunciation'),
                ...
                _nav(
                  context,
                  Icons.explore,
                  languageService.t('qibla_direction'),
                  'qibla',
                ),
                _nav(
                  context,
                  Icons.calendar_today,
                  languageService.t('islamic_calendar'),
                  'calendar',
                ),
                const Divider(),
                ...
                _nav(
                  context,
                  Icons.bar_chart,
                  languageService.t('reading_statistics'),
                  'statistics',
                ),
                _nav(
                  context,
                  Icons.cloud_upload_outlined,
                  languageService.t('backup_sync'),
                  'backup',
                ),
                _nav(
                  context,
                  Icons.info_outline,
                  languageService.t('about'),
                  'about',
                ),
                _nav(
                  context,
                  Icons.help_outline,
                  languageService.t('support_faq'),
                  'support',
                ),
